 ...
 * @author gabri
 */
public class JanelaExibeVendas extends javax.swing.JFrame {

    /**
     * Creates new form JanelaExibeVendas
     */
    public JanelaExibeVendas() {
        initComponents();
        ExibirVendas();
    ...
    private void ExibirVendas(){
        ...
        for(Venda v : dao.read()){
            String dataString = v.getDataVenda();
            int idx = dataString.indexOf(" ");
            String data = dataString.substring(0, idx);
            String hora = dataString.substring(idx+1);
    ...
    private void initComponents() {
        ...
        jLabel38.setText("Perfomece de Vendas");

        jLabel39.setFont(new java.awt.Font("Trebuchet MS", 0, 10)); // NOI18N
        jLabel39.setForeground(new java.awt.Color(0, 51, 255));
        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img_azul/iconsPerformaceVendas_80px.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaExibeVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaExibeVendas().setVisible(true);
            }
        });
    }
